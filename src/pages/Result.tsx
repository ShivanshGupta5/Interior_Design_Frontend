...
//   const full = url ? `${API_BASE}${url}` : null;
...
//           </h2>
//           <p className="text-white/40 dark:text-white/40 light:text-slate-500 font-medium transition-colors">Your space has been successfully transformed by AI</p>
//         </motion.div>
...
//             <h4 className="text-white dark:text-white light:text-slate-900 font-bold mb-2 transition-colors">Design Summary</h4>
...
//           </GlassCard>
//           <GlassCard className="border-white/5">
//             <h4 className="text-white dark:text-white light:text-slate-900 font-bold mb-2 transition-colors">Next Steps</h4>
//             <p className="text-white/40 dark:text-white/40 light:text-slate-500 text-sm leading-relaxed transition-colors">
